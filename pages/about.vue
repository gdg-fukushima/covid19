<template>
  <div class="About">
    ...
    <StaticCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、Code for Fukushimaという開発者のコミュニティで活動する有志の技術者が開設したものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          '福島県による公式情報と客観的な数値をわかりやすく伝えることで、福島県にお住まいの方や、福島県内に拠点を持つ企業の方、福島県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
      <br />
      <br />
    ...
    <StaticCard>
      ...
      >
        <a
          href="https://www.pref.fukushima.lg.jp/sec/21045c/kansenkangokango68.html"
          target="_blank"
          rel="noopener"
          place="dataSite"
        >
          {{ $t('新型コロナウイルス関連感染症について') }}
        </a>
      </i18n>
    </StaticCard>
    <StaticCard>
